...
<div class="container mt-4 mb-4 d-flex justify-content-center">
    <div class="card bdcard" style="width: 90%;">
        <div class="card-body">
            ...
            <h6>&emsp;&emsp;- ออมเงินขั้นต่ำ 1 ครั้ง/สัปดาห์</h6>
            <h6>&emsp;&emsp;- ออมเงินขั้นต่ำ 100฿<br><font color="red">*หากมีการออมไม่ครบหรือขาดออมจะถูกนับเป็น 1 ครั้ง / 2 ครั้งจะถูกตักเตือน / 3 ครั้งจะขออนุญาตเชิญออกจากห้องออม (ในกรณีออมไม่ครบหรือขาดออมและมาชำระในเดือนถัดไป จะต้องชำระให้ถึงจำนวนขั้นต่ำของเดือนที่แล้ว)</font></h6>
            ...
            <h6>&emsp;&emsp;- ออมเงินขั้นต่ำ 1 ครั้ง/สัปดาห์</h6>
            <h6>&emsp;&emsp;- ออมเงินขั้นต่ำ 200฿</h6>
            <h6>&emsp;&emsp;- มีรางวัลสำหรับ Top Spender สูงที่สุดตั้งแต่การออมในช่วง General Election จนถึงวันปิดโหวต 1 รางวัล</h6>
