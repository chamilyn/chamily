        ...
        <div class="card" style="width: 90%;">
            <div class="card-body" style="text-align: -webkit-center;">
                ...
                <div class="container mt-2" style="text-align-last: end;">
                    ...
                    <a id="arrow_down"><button class="btn btn-warning" style="text-align-last: center;"><i class="fa fa-arrow-left"></i></button></a>
                    <a id="arrow_up"><button class="btn btn-warning" style="text-align-last: center;"><i class="fa fa-arrow-right"></i></button></a>
                </div>
