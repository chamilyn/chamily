                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row g-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text textbgcl"><b>- Fist Perfomance -</b></p>
                                    <p class="card-text">เชิญชวนทุกคนมาเล่นน้ำมาเอ็นจอยมาสนุกสนาน</p>
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row g-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text textbgcl"><b>- Roadshow -</b></p>
                                    <p class="card-text">ซิง 6 ตะไมแชมไม่ไปง่ะคิดถึงสุดหัวใจเลย ;-;</p>
